...
from src.cleaning.dedup.exact import compute_dedup_key, normalize_text
from src.cleaning.storage.payload import PayloadRef, delete_payload_files, load_payload, reset_payload_dir
from src.cleaning.storage.winners import WinnerMixin
from src.common.sqlite import apply_runtime_pragmas
...
class StagingDB(WinnerMixin):
    def __init__(
        ...
        apply_runtime_pragmas(self.conn)
        self._ensure_schema()
